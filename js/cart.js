...
function removeAnItem(product_id, e) {
    e.parentNode.parentNode.parentNode.removeChild(e.parentNode.parentNode.parentNode);
    for (var i = 0; i < products.length; i++) {
...
html += "<table id='tblCart' border='1|1' align='center'>";
